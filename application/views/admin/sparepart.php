    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          <img src="assets/img/brand/demia.png" class="navbar-brand-img" alt="...">
        </a>
      </div>
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Alfina Dwi R</span>
                  </div>
                </div>
              </a>
          ...
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="#" class="btn btn-sm btn-neutral">
                <i class="ni ni-fat-add text-primary"></i> New
              </a>
              <a href="#" class="btn btn-sm btn-neutral">
                <i class="ni ni-align-left-2 text-primary"></i> Filters
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-center  text-lg-left  text-muted">
              &copy; 2021 <a href="https://www.diaelec.co.jp/en/" class="font-weight-bold ml-1" target="_blank">Engineering Tim</a>
            </div>
          </div>
          <div class="col-lg-6">
            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
              <li class="nav-item">
                <a href="https://www.diaelec.co.jp/en/" class="nav-link" target="_blank">
                 Diamond Electric Mfg Indonesia 
                </a>
              </li>
            </ul>
          </div>
